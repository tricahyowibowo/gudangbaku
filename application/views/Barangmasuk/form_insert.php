      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <!-- form start -->
            <div class="container">
            <form action="<?=base_url('barangmasuk/input_data')?>" role="form" method="post">
              ...
              <div class="box-footer" style="width:93%;">
                ...
                <a type="button" class="btn btn-info" style="width:14%;margin-right:29%" href="<?=base_url('barangmasuk')?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Lihat List Barang</a>
