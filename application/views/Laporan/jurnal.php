        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?=site_url('laporan/jurnalexcel/'.$page.'/'.$akun.'/'.$tgl_awal.'/'.$tgl_akhir)?>" type="button" class="btn btn-success pull-right"><i class="fa fa-download"></i> <span> Export Excel</span></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
