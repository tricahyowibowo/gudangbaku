  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Tables</li>
        <li class="active"><a href="<?=base_url('Datasupplier')?>">Tabel Data supplier</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- Tabel -->
              <a href="<?=base_url('supplier/tambahdata')?>" style="margin-bottom:10px;" type="button" class="btn btn-primary" name="tambah_data"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah supplier</a>
