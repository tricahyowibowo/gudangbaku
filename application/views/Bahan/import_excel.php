      ...
      <div class="col-xs-12">
        <div class="box box-primary">
          ...
          <div class="box-body">
            ...
            <?php } ?>
            <form class="form-horizontal" action="<?=base_url('bahan/spreadsheet_import')?>" role="form" method="post"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="tgl_transaksi" class="col-sm-4 control-label" >Template :</label>
                      <div class="col-sm-3">
                        <a href="<?=base_url('bahan/format_excel')?>" class="btn btn-info"><i class="fa fa-download" aria-hidden="true"></i> unduh template</a>
                      </div>
                </div>
